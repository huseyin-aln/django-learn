...
class StudentDetail(APIView):
    ...
    def put(self, request, pk):
        ...
        if serializer.is_valid():
            ...
            new_data['success'] = f"student {student.last_name} updated seccuessfully!"
    ...
    def delete(self, request, pk):
        ...
        student.delete()
        data = {
            "message" : f"student {student.last_name} deleted seccuessfully!"
        }
        return Response(data, status=status.HTTP_204_NO_CONTENT)


### CBV VIEWS ### ### Generic APIView ###
class StudentListCreate(mixins.ListModelMixin, mixins.CreateModelMixin, GenericAPIView): # GenericAPIView en sağda olacak olacak inherit edildiği icin
